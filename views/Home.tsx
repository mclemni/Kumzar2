  ...
  return (
    <>
      ...
      <section className="py-24 max-w-[1200px] mx-auto px-16 bg-white">
        <p className="text-xs font-bold tracking-widest text-brand-accent mb-8">QUALITY THAT LASTS</p>
        <h2 className="text-4xl font-light text-brand-dark leading-snug max-w-4xl">
      ...
      <section className="pb-24 max-w-[1200px] mx-auto px-16 grid grid-cols-4 gap-6 bg-white">
        {[
      ...
      <section className="bg-slate-50 py-24 border-y border-slate-100">
        <div className="max-w-[1200px] mx-auto px-16 grid grid-cols-12 gap-16 items-center">
           <div className="col-span-5">
              <h2 className="text-5xl font-light text-brand-dark mb-8">Uncompromising commitment to safety</h2>
              <p className="text-slate-500 font-light leading-relaxed mb-8">
                Our operations are conducted in accordance with internationally recognized management system standards to ensure compliance, consistency, and operational reliability.
              </p>
           ...
           <div className="col-span-7 aspect-video overflow-hidden border-8 border-white shadow-xl">
      ...
      <section className="py-24 max-w-[1200px] mx-auto px-16">
         <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-brand-dark">Our Strategic Partners</h2>
            <p className="text-slate-400 mt-4">Working together with global leaders to build Iraq's infrastructure.</p>
         </div>
         <div className="grid grid-cols-2 gap-12">
            <div 
              className="p-12 border border-slate-100 flex items-center justify-between group cursor-pointer hover:border-brand-accent transition-all"
              onClick={() => handlePartnerClick('al-faw-tunnel')}
            >
               <div>
                  <h3 className="text-3xl font-light text-brand-dark mb-2">Sika®</h3>
                  <p className="text-sm text-slate-400 font-light">Authorized Agent & Representative</p>
               </div>
            ...
            >
               <div>
                  <h3 className="text-3xl font-light text-brand-dark mb-2">Ardh Al-Multaqa</h3>
                  <p className="text-sm text-slate-400 font-light">Contracting & Logistics Partner</p>
               </div>
               <ArrowRight size={24} className="text-brand-accent group-hover:translate-x-2 transition-transform" />
            </div>
         </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-[1200px] mx-auto px-16">
          <div className="flex justify-between items-end mb-12">
            <h2 className="text-4xl font-light text-brand-dark">Latest Updates</h2>
          ...
          <div className="grid grid-cols-2 gap-8">
            {NEWS.map((item) => (
              <div key={item.id} className="bg-white border border-slate-100 p-8 flex gap-8 hover:shadow-lg transition-all cursor-pointer group">
      ...
      <section className="h-[400px] relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-8">
          <p className="text-brand-accent text-xs font-bold tracking-[0.4em] uppercase mb-4">ENGINEERING THE FUTURE</p>
          <h2 className="text-5xl font-light leading-tight mb-8">Building Iraq's Industrial<br/><span className="italic">Excellence</span></h2>
          <button className="px-12 py-4 border border-brand-accent text-brand-accent font-bold text-xs tracking-widest uppercase hover:bg-brand-accent hover:text-brand-dark transition-all">
             Partner with us
          </button>
        </div>
      </section>
